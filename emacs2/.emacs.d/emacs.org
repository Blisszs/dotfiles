...
#+BEGIN_SRC emacs-lisp
  (use-package org-capture
    ...
    (setq org-capture-templates 
	  '(("t" "tasks" entry (file+headline "~/org/org-capture.org" "Todo") "* TODO %?\n  %i\n") ;; Creates a TODO headline in the entry "Todo". If there is a marked region, it will be copied over.

	    ("a" "activity")
	    ("as" "scheduled" entry (file+headline "~/org/org-capture.org" "Scheduled") "* %?\n SCHEDULED: %^T ") ;; Creates an headline under the entry "Scheduled" and it will ask for a date.
	    ("ad" "deadline" entry (file+headline "~/org/org-capture.org" "Deadline") "* %?\n DEADLINE: %^T ") ;; Creates an headline under the entry "Scheduled" and it will ask for a date.
	    ...
	    ("t" "television, movies and anime")
	    ("ts" "television series" entry (file+headline "~/org/tv-list.org" "series") "* %? \n :PROPERTIES: \n :DIRECTOR: \n :RELEASE_DATE: \n :EPISODE_COUNT: \n :END:")
	    ))
