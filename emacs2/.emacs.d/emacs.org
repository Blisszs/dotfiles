...
#+BEGIN_SRC emacs-lisp
  (use-package org-capture
    ...
    (setq org-capture-templates 
	  '(("t" "tasks" entry (file+headline "~/MEGA/org/agenda/life.org" "Todo") "* TODO %?\n  %i\n") ;; Creates a TODO headline in the entry "Todo". If there is a marked region, it will be copied over.
	  
	    ("a" "activity")
	    ("as" "scheduled" entry (file+headline "~/MEGA/org/agenda/life.org" "Scheduled") "* TODO %?\n SCHEDULED: %^T \n") ;; Creates an headline under the entry "Scheduled" and it will ask for a date.
	    ("ad" "deadline" entry (file+headline "~/MEGA/org/agenda/life.org" "Deadline") "* TODO %?\n DEADLINE: %^T \n") ;; Creates an headline under the entry "Scheduled" and it will ask for a date.
	    ("al" "learn" entry (file+headline "~/MEGA/org/agenda/life.org" "Learn") "* LEARN %? [/] \n - [ ] ")
	    ("ar" "routine" entry (file+headline "~/MEGA/org/agenda/life.org" "Routine") "* REPEAT %? \n  SCHEDULED: %^t \n:PROPERTIES:\n:STYLE: habit\n:END: ")
	  
	    ("i" "ideas and thoughts")
	    ("ij" " journal" entry (file+headline "~/MEGA/org/journal.org" "journal") "* %T %? \n")
	    ("ii" "idea" entry (file+headline "~/MEGA/org/agenda/ideas.org" "idea") "* IDEA %?")
	    ...
	    ("b" "book and manga")
	    ("bb" "book" entry (file+headline "~/MEGA/org/lists/book-list.org" "book") "* %^{PROMPT|READING|READ|COMPLETED|DROPPED} %? \n :properties: \n :author: \n :release_date: \n :page_count: \n :chapters_count: \n :end: \n")
	    ("bm" "manga" entry (file+headline "~/MEGA/org/lists/book-list.org" "manga") "* %^{PROMPT|READING|READ|COMPLETED|DROPPED} %? \n :properties: \n :author: \n :release_date: \n :page_count: \n :chapters_count: \n :end: \n")
	  
	    ("v" "television, movies and anime")
	    ("vs" "television series" entry (file+headline "~/MEGA/org/lists/tv-list.org" "series") "* %^{PROMPT|PLAN_TO_WATCH|WATCHING|COMPLETED|DROPPED} %? \n :PROPERTIES: \n :DIRECTOR: \n :RELEASE_DATE: \n :EPISODE_COUNT: \n :END: \n")
	    ("va" "anime" entry (file+headline "~/MEGA/org/lists/tv-list.org" "anime") "* %^{PROMPT|PLAN_TO_WATCH|WATCHING|COMPLETED|DROPPED} %? \n :PROPERTIES: \n :DIRECTOR: \n :RELEASE_DATE: \n :EPISODE_COUNT: \n :END: \n")
	    ("vm" "movie" entry (file+headline "~/MEGA/org/lists/tv-list.org" "movies") "* %^{PROMPT|PLAN_TO_WATCH|WATCHING|COMPLETED|DROPPED} %? \n :PROPERTIES: \n :DIRECTOR: \n :RELEASE_DATE: \n :DURATION: \n :END: \n")
	  
	    ("d" "duvidas" entry (file+headline "~/MEGA/org/agenda/life.org" "duvidas") "* TODO %?")
	    ))
...
#+BEGIN_SRC emacs-lisp
  (use-package org-agenda
    :custom
    (org-agenda-files '("~/MEGA/org/agenda"))
    :bind
    ("C-c o a" . org-agenda))
#+END_SRC
** org-bullets
